...
export enum MongoDB {
  ...
  ObsoleteConfigServersInconsistent = 132,
  ...
  ObsoleteBalancerLostDistributedLock = 191,
  ...
  ObsoleteReceivedOpReplyMessage = 198,
  ...
  NotYetAvailableTransactionAborted = 244,
  BrokenPromise = 245,
  ...
  TooManyFilesOpen = 261,
  FailPointSetFailed = 262,
  OperationNotSupportedInTransaction = 263,
  TooManyLogicalSessions = 264,
  OrphanedRangeCleanUpFailed = 265,
  ExceededTimeLimit = 266,
  PreparedTransactionInProgress = 267,
  SocketException = 9001,
  ObsoleteRecvStaleConfig = 9996,
  NotMaster = 10107,
