...
export enum MONGODB_EXIT {
  SUCCESSFUL_EXIT = 0,
  OPTIONS_ERROR = 2,
  HOSTNAME_MISMATCH = 3,
  VERSION_MISMATCH = 4,
  INSTALLATION_ISSUE = 5,
  WINDOWS_SHUTDOWN_EVENT = 12,
  SYSTEM_EXIT__UNCLEAN_SHUTDOWN = 14,
  WINDOWS__WSASTARTUP_FAILED__NT_SERVICE_ERROR = 20,
  LISTEN_ERROR = 48,
  INCOMPATIBLE_DATAFILES = 62,
  UNCAUGHT_EXCEPTION = 100,
}
...
export enum MONGODB {
  ...
  OBSOLETE__DATABASE_NOT_FOUND = 60,
  ...
  OBSOLETE__READ_AFTER_OPTIME_TIMEOUT = 122,
  ...
  RLP_INITIALIZATION_FAILED = 131,
  OBSOLETE__CONFIG_SERVERS_INCONSISTENT = 132,
  ...
  OBSOLETE__NEEDS_DOCUMENT_MOVE = 156,
  ...
  OBSOLETE__BALANCER_LOST_DISTRIBUTED_LOCK = 191,
  ...
  OBSOLETE__RECEIVED_OP_REPLY_MESSAGE = 198,
  ...
  NOT_YET_AVAILABLE__TRANSACTION_ABORTED = 244,
  BROKEN_PROMISE = 245,
  ...
  OBSOLETE__PREPARE_CONFIGS_FAILED = 13104,
}
